def guess_the_word():
    ...
    def play():
        ...
        while lives > 0:
            ...
            elif your_guess in letters_used:
                print("You've already guessed that letter")
            elif your_guess in word:
                letters_used.append(your_guess)
                print("Great guess!")
            else:
                lives -= 1
                letters_used.append(your_guess)
                print(f"Wrong guess. you have {lives} life(s) left")

            display = [letter if letter in letters_used else '_ ' for letter in word]
            print(' '.join(display))
